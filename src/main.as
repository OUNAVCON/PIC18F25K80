...
# 37209 "/opt/microchip/xc8/v1.44/include/pic18f25k80.h"
TOSU equ 0FFFh ;# 
	FNCALL	_main,_blinkLed
	FNCALL	_main,_initCan
...
; #config settings
global __CFG_RETEN$OFF
__CFG_RETEN$OFF equ 0x0
global __CFG_INTOSCSEL$HIGH
__CFG_INTOSCSEL$HIGH equ 0x0
global __CFG_SOSCSEL$HIGH
__CFG_SOSCSEL$HIGH equ 0x0
global __CFG_XINST$OFF
__CFG_XINST$OFF equ 0x0
global __CFG_FOSC$INTIO2
__CFG_FOSC$INTIO2 equ 0x0
...
global __CFG_BORPWR$ZPBORMV
__CFG_BORPWR$ZPBORMV equ 0x0
global __CFG_WDTEN$OFF
__CFG_WDTEN$OFF equ 0x0
global __CFG_WDTPS$1048576
__CFG_WDTPS$1048576 equ 0x0
global __CFG_CANMX$PORTB
__CFG_CANMX$PORTB equ 0x0
global __CFG_MSSPMSK$MSK7
__CFG_MSSPMSK$MSK7 equ 0x0
global __CFG_MCLRE$ON
__CFG_MCLRE$ON equ 0x0
global __CFG_STVREN$ON
__CFG_STVREN$ON equ 0x0
global __CFG_BBSIZ$BB2K
__CFG_BBSIZ$BB2K equ 0x0
...
__pcstackCOMRAM:
?_initGpio:	; 1 bytes @ 0x0
??_initGpio:	; 1 bytes @ 0x0
?_initCan:	; 1 bytes @ 0x0
??_initCan:	; 1 bytes @ 0x0
...
;;  myWord          2    5[COMRAM] unsigned int 
;;  myByte          1    0        unsigned char 
...
l664:
	call	_initGpio	;wreg free
	line	22
	call	_initCan	;wreg free
	goto	l666
	line	24
...
l666:
	infsnz	((c:main@myWord)),c
	incf	((c:main@myWord+1)),c
	line	26
	
l668:
		movlw	137
	subwf	 ((c:main@myWord)),c,w
	movlw	19
	subwfb	((c:main@myWord+1)),c,w
	btfss	status,0
	goto	u21
	goto	u20
...
l670:
	movlw	high(0)
	movwf	((c:main@myWord+1)),c
	movlw	low(0)
	movwf	((c:main@myWord)),c
	line	28
	
l672:
	call	_blinkLed	;wreg free
	goto	l666
	line	30
...
psect	text2
	file	"can.c"
	line	5
	global	__size_of_initCan
	__size_of_initCan	equ	__end_of_initCan-_initCan
